...
- (NSUInteger)SODK_characterCount:(NSString *)str
{
    NSUInteger cnt = 0;
    NSUInteger index = 0;
...
- (void)paste:(id)sender
{
    ...
    if (text)
    {
        ...
        UITextPosition *pos = [self positionFromPosition:start inDirection:UITextLayoutDirectionRight offset:[self SODK_characterCount:text]];
